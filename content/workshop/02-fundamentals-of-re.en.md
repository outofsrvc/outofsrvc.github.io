...
description: "Curated references for building your reverse engineering fundamentals."
...
> Every science rests upon pillars..
> and the pillars of our era are those that reside beneath the fortress of 0 and 1.
...
🔗 [Networking Fundamentals Series on the Shell Network](https://sh3ll.cloud/xf2/threads/162/)

![Lesson from the networking series](/assets/img/workshop/fundamentals/net-series.png)
_Figure (4): Excerpt from the networking lessons by brother Storm._

---

## 5. Low-Level Programming

The most important matter in reverse engineering is learning and understanding Assembly code. Why?
Because when reverse engineering any program, we are dealing with executable code in machine language (Machine Code), that is, it is represented in zeros and ones (Binary System).
